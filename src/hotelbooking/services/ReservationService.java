...
import hotelbooking.dto.ReservationDetails;
...
import hotelbooking.pricing.PricingPolicy;
...
public class ReservationService {
    ...
    public int createReservationAutoRoom(int guestId,
        ...
        var pricing = PricingPolicy.getInstance();
        double totalPrice = pricing.total(chosen.getPricePerNight(), nights);
        double minDeposit = pricing.minDeposit(totalPrice);
